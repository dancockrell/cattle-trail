...
def main():
    ...
    parser.add_argument('checks', nargs='*', metavar='CHECK', help='state, phase, turn, clock, lantern, lantern-view, lantern-controller, storage, snapshot, compile, room, companion, or motion; defaults to state')
