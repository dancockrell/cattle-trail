...
West-hand correction: eleanor-lantern-west-hand-v2 places the lantern in the far/anatomical right hand and leaves the near left hand empty, with actual west facing and no mirrored processing. It is one whole contact pose awaiting the rest of its corrected sequence. Ada-east-opposite-contact-v3 preserves identity but still does not convincingly invert the lead leg; retain as unadmitted evidence, not a completed cycle.
