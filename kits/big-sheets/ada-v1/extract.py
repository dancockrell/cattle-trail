...
specs=[(HERE,6,['walk_southeast','walk_northeast','walk_east','turn_endviews','repair','expressive_gestures']),
       (HERE/'sheet02',4,['walk_northwest','walk_north','walk_northeast','walk_west']),
       (HERE/'sheet03',4,['jog_southeast','jog_south','jog_southwest','jog_east']),
       (HERE/'sheet04',4,['breathing_idle','repair_work','talk','camp_care'])]
for sheet_number,(folder,rows,row_names) in enumerate(specs,1):
