...
refs=[('identity','kits/wardrobe/rancher-summer-v1/cream_offshoulder_split_skirt-full-resolution.png'),('camera_only','kits/wardrobe/ines-high-angle-v1/source.png')]
metadata={'version':1,'id':'eleanor_high_angle','age':24,'cell':[256,256],'anchor':[128,244],'body_height':160,
    ...
    'tool':'builtin image_gen','status':'high_angle_master_candidate','runtime_admitted':False,'animation_clips':{},
    'actual_camera':'Highthreequarter southeast: broad visiblecrown/topshoulders, shortenedtorsoandlegprojection, visiblebootuppers. Elevation clearlyincreased relative to summersource; exactdegrees notmeasured.',
    ...
    'limitations':['Static master only; no turn/walk clip.','Bust definition exceeds originalsmallchestpreference, retainedasreviewcandidate.','Costume remains period-inspired fantasy rather than reconstructed1870sdress.'],
