...
for i, box in enumerate(components):
    crop = keyed.crop(box)
    crop.save(HERE / f'rancher-{i+17:02d}-trim.png')
    ...
    variants.append({'id':f'rancher_{i+17:02d}','rect':[x,y,64,64],'age':24,
...
prefix = 'kits/character-families/rancher/batch02/'
record = {'id':'rancher-batch02','family':'rancher','master_image':'kits/character-families/rancher/master-v1.png',
